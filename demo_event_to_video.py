...
# an event-based camera or a RAW, DAT or HDF5 event file.
...
# Use --delta_t 10000 to select accumulation time in micro-seconds
# Use --video_path /path/to/output to generate a mp4 video